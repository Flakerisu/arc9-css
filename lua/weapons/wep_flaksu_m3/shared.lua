...
SWEP.PrintName = "Leone 12G Super"
...
SWEP.ViewModelFOVBase = 60 -- Set to override viewmodel FOV
...
SWEP.PhysBulletMuzzleVelocity = 22000 -- Physical bullet muzzle velocity in Hammer Units/second. 1 HU != 1 inch.
SWEP.PhysBulletDrag = 2 -- Drag multiplier
...
SWEP.EjectDelay = 0.5 -- When eject shell on cycle (pretty dumb, better'd just use EjectAt)
...
SWEP.DispersionSpreadMultMove = 2 -- Applied when speed is equal to walking speed.
SWEP.DispersionSpreadMultMidAir = 3 -- Applied when not touching the ground.
SWEP.DispersionSpreadMultHipFire = 1 -- Applied when not sighted.
SWEP.DispersionSpreadMultSighted = 0.5 -- Applied when sighted. Can be negative.
SWEP.DispersionSpreadMultBlindFire = 2 -- Applied when blind firing.
SWEP.DispersionSpreadMultCrouch = 0.7 -- Applied when crouching.

SWEP.DispersionSpreadMultRecoil = 1.05 -- Applied per unit of recoil.
...
SWEP.ShootSound = "weapons/m3/m3-1.wav"                            -- Fire
