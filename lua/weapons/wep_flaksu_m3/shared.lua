...
SWEP.PushBackForce = 10 -- Push the player back when shooting.
...
SWEP.RecoilKick = 6 -- Camera recoil
...
SWEP.DispersionSpreadMultMove = 2/1.5 -- Applied when speed is equal to walking speed.
SWEP.DispersionSpreadMultMidAir = 3/1.5 -- Applied when not touching the ground.
...
SWEP.DispersionSpreadMultBlindFire = 2/1.5 -- Applied when blind firing.
