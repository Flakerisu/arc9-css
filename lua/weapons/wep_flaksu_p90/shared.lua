...
SWEP.WorldModel = "models/weapons/w_smg_p90.mdl" -- If you are going to MirrorVMWM: Put here some optimized model with collisions. Css/hl2 weapon worldmodels that are included in gmod are great for it - like "models/weapons/w_rif_m4a1.mdl"
...
SWEP.RangeMax = 545 -- In Hammer units, how far bullets can travel before dealing DamageMin.
...
SWEP.VisualRecoilSide = 0.3 -- Horizontal tilt for visual recoil.
SWEP.VisualRecoilRoll = 0.35 -- Roll tilt for visual recoil.
...
SWEP.SpreadMultMidAir = 2 -- Applied when not touching the ground.
...
SWEP.SpreadMultRecoil = 1.05 -- Applied per unit of recoil.
...
SWEP.ShootSound = "weapons/p90/p90-1.wav"                            -- Fire
