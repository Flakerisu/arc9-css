...
SWEP.TrueName = "Desert Eagle .50AE"
...
SWEP.Class = "High Caliber Pistol"
...
-- }
SWEP.Credits = {
    Original_Port1 = "https://steamcommunity.com/id/danielgonzales2012",
    ARC9_Port2 = "https://steamcommunity.com/id/flakerisu/",
    Base3 = "https://steamcommunity.com/sharedfiles/filedetails/?id=2910505837",
}
...
SWEP.Description = [[An iconic pistol that is difficult to master but surprisingly accurate at long range.]]
-- Multi-line strings are possible with the double square brackets.]]

SWEP.UseHands = true -- Same as weapon_base
SWEP.EntitySelectIcon = true -- Set to true to try and use the Entity image as select icon
SWEP.CustomSelectIcon = nil -- Set to use a non-autogenerated select icon

SWEP.ViewModel = "models/weapons/cstrike/c_pist_deagle.mdl"
SWEP.WorldModel = "models/weapons/w_pist_deagle.mdl" -- If you are going to MirrorVMWM: Put here some optimized model with collisions. Css/hl2 weapon worldmodels that are included in gmod are great for it - like "models/weapons/w_rif_m4a1.mdl"
...
SWEP.RangeMax = 970 -- In Hammer units, how far bullets can travel before dealing DamageMin.
...
SWEP.ArmorPiercing = 2 -- Between 0-1. A proportion of damage that is done as direct damage, ignoring protection.
...
SWEP.PhysBulletMuzzleVelocity = 33000 -- Physical bullet muzzle velocity in Hammer Units/second. 1 HU != 1 inch.
...
SWEP.RecoilResetTimeSighted = -0.09
...
SWEP.RecoilKickDamping = 28.06 -- Camera recoil damping
...
SWEP.SpreadMultMove = 2 -- Applied when speed is equal to walking speed.
SWEP.SpreadMultMidAir = 3 -- Applied when not touching the ground.
SWEP.SpreadMultHipFire = 1 -- Applied when not sighted.
SWEP.SpreadMultSighted = 0.1 -- Applied when sighted. Can be negative.
SWEP.SpreadMultBlindFire = 2 -- Applied when blind firing.
SWEP.SpreadMultCrouch = 0.5 -- Applied when crouching.

SWEP.SpreadMultRecoil = 1.25 -- Applied per unit of recoil.
...
SWEP.ShootSound = "weapons/deagle/deagle-1.wav"                            -- Fire
...
SWEP.EnterSightsSound = "weapons/zoom.wav"
...
SWEP.CamQCA_Mult_ADS = 0.5 -- Intensity for QC camera movement in ADS.
...
SWEP.IronSights = {
    Pos = Vector(-4.4, -5, 1.28),
    Ang = Angle(0.07, 0.45, 0.2),
    Magnification = 1.1,
...
SWEP.MovingPos = Vector(0, -1.5, -0.5) -- Vector(0, 0, 0)
SWEP.MovingAng = Angle(0, 0.5, 0) -- Angle(0, 0, 0)

-- Position when crouching
SWEP.CrouchPos = Vector(-3, -2, -3)
SWEP.CrouchAng = Angle(0, 2, -15)

-- Position when sprinting or safe
SWEP.RestPos = Vector(0, 0, -13)
SWEP.RestAng = Angle(0, 60, 0)
...
SWEP.AnimDraw = ACT_GESTURE_FLINCH_LEFTARM
