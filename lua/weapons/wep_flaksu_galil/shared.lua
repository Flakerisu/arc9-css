...
SWEP.WorldModel = "models/weapons/w_rif_galil.mdl" -- If you are going to MirrorVMWM: Put here some optimized model with collisions. Css/hl2 weapon worldmodels that are included in gmod are great for it - like "models/weapons/w_rif_m4a1.mdl"
...
SWEP.RangeMax = 640 -- In Hammer units, how far bullets can travel before dealing DamageMin.
...
SWEP.ArmorPiercing = 0.77 -- Between 0-1. A proportion of damage that is done as direct damage, ignoring protection.
...
SWEP.RecoilKickDamping = 56.12 -- Camera recoil damping
...
SWEP.SpreadMultRecoil = 1.1 -- Applied per unit of recoil.
...
SWEP.ShootSound = "weapons/galil/galil-1.wav"                            -- Fire
...
SWEP.IronSights = {
    Pos = Vector(-5.24, -5, 2.25),
    Ang = Angle(-0.41, -1.4, 0),
    Magnification = 1.2,
...
SWEP.MovingPos = Vector(0, -3.5, -0.5) -- Vector(0, 0, 0)
...
SWEP.RestPos = Vector(-1, -3, 3)
SWEP.RestAng = Angle(15, -25, -30)
...
SWEP.PeekPos = Vector(6, 5, -2)
SWEP.PeekAng = Angle(4.5, 2, 45)
...
SWEP.AnimDraw = ACT_FLINCH_RIGHTARM
